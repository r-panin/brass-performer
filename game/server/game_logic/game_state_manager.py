...
class GameStateManager:
    ...
    def action_context(self) -> ActionContext:
        return self._state.transaction_state.action_context
    ...
    def start_transaction(self, context: ActionContext) -> None:
        ...
        self._state.transaction_state.action_context = context
    ...
    def add_subaction(self) -> None:
        ...
        if self._state.transaction_state.subaction_count >= max_actions:
            ...
            self._state.transaction_state.action_context = ActionContext.AWAITING_COMMIT
    ...
    def commit_transaction(self) -> None:
        ...
        self._state.transaction_state.action_context = ActionContext.MAIN
        self._state.transaction_state.subaction_count = 0
    ...
    def end_turn(self) -> None:
        ...
        self._state.transaction_state.action_context = ActionContext.END_OF_TURN
    
    def start_new_turn(self, new_state: BoardState) -> None:
        """Начинает новый ход"""
        if self.action_context is not ActionContext.SHORTFALL:
            self._state.phase = GamePhase.MAIN
            new_state.action_context = ActionContext.MAIN
        self._state.transaction_state.subaction_count = 0
    ...
    def enter_shortfall(self):
        self._state.transaction_state.action_context = ActionContext.SHORTFALL
    ...
    def enter_gloucester_develop(self):
        self._state.transaction_state.action_context = ActionContext.GLOUCESTER_DEVELOP
    ...
    def _get_max_actions(self) -> int:
        ...
        if self._state.transaction_state.action_context in self.SINGLE_ACTION_CONTEXTS:
            return 1
        elif self._state.transaction_state.action_context in self.DOUBLE_ACTION_CONTEXTS:
            return 2
        return float('inf')
